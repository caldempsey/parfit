...
## [0.4.5](https://github.com/caldempsey/parfit/compare/v0.4.4...v0.4.5) - 2026-04-25

### Other

- replace cargo-dist with goreleaser for release artifacts
- *(reflow)* make FenceStack 'static since the fence table is compile-time
